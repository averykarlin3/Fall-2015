...
\end{enumerate}
\item Other sections in memory are code (the executable section of an object file, often stored in ROM until run), bss (global or static initialized variables), and data (global or static uninitialized variables)
