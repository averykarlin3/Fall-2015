...
\end{enumerate}
\item Central dispatch server maintains communication with each of the clients simultaneously through maintaining pipes to each of the subservers, allowing communication with clients
\end{enumerate}
