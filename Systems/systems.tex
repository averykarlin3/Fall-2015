...
\end{enumerate}
\item Most file control functions are within ``fcntl.h''
\begin{enumerate}
\item open(\textit{file\_path, flags, mode}) - Opens/adds the file to the next file table space, returning the file descriptor
\begin{enumerate}
