...
\item String and array variables are functionally immutable, such that they should not be changed without creating a different point in memory, unlike pointers
\item All other variables are mutable, such that they can be changed easily
\end{enumerate}
