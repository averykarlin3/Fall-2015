...
\item Compiler allocated memory is packaged within the binary, without a default value, where variables and arrays are allocated
\item GET REMAINING NOTES FROM THIS
\end{enumerate}
