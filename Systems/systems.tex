...
\begin{enumerate}
\item The source must be a pointer to the string, and is modified such that it points to the character after the delimeter, or null if there is no instance
