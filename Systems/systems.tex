...
\item Fragment info is the number of packets the data is broken up into, including the current number of fragment
...
\end{enumerate}
\end{enumerate}
\item The fourth layer is the transport layer, used for 
\end{enumerate}
\end{enumerate}
