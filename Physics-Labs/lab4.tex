...
$$\tau_{1} \text{(Case 1)} = r_1F_1 = r_1(m_1 + m_c)g = 0.35*(0.1 + )*9.8 = $$
$$\tau_{cc} \text{(Case 2a)} = \tau_1 + \tau_3 = r_1F_1 + r_3F_3 = 

\begin{center}
\begin{tabular}
{|m{7em}|m{7em}|m{7em}|}
\hline
Case Number & Moment/Lever Arms (m) & Counterclockwise Torque (N*m) & Clockwise Torque (N*m) \\
\hline
Case 1 & $r_1 = 0.35, r_2 = 0.177$ &  
\hline
Case 2a & $r_1 = 0.2, r_2 = 0.2, r_3 = 0.469$ &  
\hline
