...
\subsection{Differentiability of Vector-Valued Functions}

\subsubsection{Linear Functions}
Consider a vector-valued linear function, $\vec{l}: \mathbb{R^d} \to \mathbb{R^e}$, mapping a line in d-space onto at most a line in e-space (such that it could be a point).

For a linear function, it is sufficient to have the properties of:
\begin{itemize}
\item Additivity: $\vec{l}(\vec{x} + \vec{y}) = \vec{l}(\vec{x}) = \vec{l}(\vec{y})$
