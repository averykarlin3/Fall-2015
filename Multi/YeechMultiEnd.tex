...
$C^1$, that $(\vec{a}, \vec{b}) \in (\dom \vec{F})^\circ$, and that
...
that $(\vec{a}, \vec{b}) \in (\dom \vec{F})^\circ$. $\dom \vec{F} = (\dom
\vec{f} \times \varmathbb{R}^d_{\vec{x}}) \subseteq
\varmathbb{R}^{2d}_{(\vec{u}, \vec{x})}$. So $\vec{b}$ is not a problem. We also
know that $\vec{a} \in \dom \vec{f}$ by assumption.
...
V\toU$ such that $\vec{F}(\vec{g}(\vec{x}), \vec{x}) \equiv \vec{0}$ for all
...
%
%Assume $\gradient g(\vec{x}) \neq \vec{0} \text{ for any } \vec{x} \in
%L_c g$. This is the \textit{nondegeneracy condition}. We can reach two
%conclusions:
%
%\begin{enumerate}
%    \item For any $\vec{p} \in L_c g$, $\exists \+ r > 0: B_r^d (\vec{p}) \cap
%        L_c g = \vec{\phi} (U)$ where $U$ is an open set in $\varmathbb{R}^{d -
%        1}$ and $\vec{\phi}$ is $C^1$ and one-to-one function such that
%        $\{\partial_{u_1} \vec{\phi}, \partial_{u_2} \vec{\phi}, \dots,
%        \partial_{u_{d - 1}} \vec{\phi}\}$ is linearly independent at every
%        point $\vec{u} \in U$. (``Full Rank condition'')
%\end{enumerate}
%We can say that any $L_c g$ is a \textbf{manifold}, or a surface of dimension
%$k$ sitting in $d$ space.
%
%\textbf{Example}: $d = 2$:
%
%\[
%    g(x, y) = x^2 + y^2, D = \varmathbb{R}^d
%\]
%\[
%    L_1 g = \{(x, y) \in \varmathbb{R}^2 \+|\+ x^2 + y^2 = 1\} = S_1^1 (0, 0)
%\]
%Here the level-set is a unit-circle, a manifold of dimension 1 sitting within
%2-space.
%
%We can also check the non-degeneracy condition, if we solve for $\gradient g(x,
%y) = \vec{0}$, we get that $(2x, 2y) = \vec{0} \to (x, y) = \vec{0} \not
%\subseteq L_c g$
...
\partial_{x_2} g(\vec{p}), \dpts, \partial_{x_d} g(\vec{p})$ cannot all be 0 (as
...
\varmathbb{R}^{d - 1} \times \varmathbb{R}$ of $\vec{p}$. In this neighborhood,
