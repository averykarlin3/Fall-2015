...
\subsection{Phillips Instability and Pre-Crisis Inflation Targeting Policy}
\begin{enumerate}
...
\item This is due to inflation expectations, %Finish Page 29 
\end{enumerate}
\end{enumerate}
...
\end{enumerate}
\item The goals of financial systems are to reduce transaction costs, risk, and the desire for liquidity, to enhance efficiency
\begin{enumerate}
\item 
\end{enumerate}
