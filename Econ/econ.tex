...
\begin{enumerate}
\item The zero bound on the nominal interest rate is due to the lack of willingness to pay to loan money, limiting the ability to lower the rate, since negative rate makes holding cash earn, such that spending will stop
