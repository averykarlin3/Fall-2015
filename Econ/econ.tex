...
\end{enumerate}
\item The Keynesian cross states that in an economy, total income (or supply due to GDP being total paid through the factor market) and total consumption (or demand) must be equal, such that the intersection of that line and the consumption curve is the actual 
