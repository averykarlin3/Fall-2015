...
\end{enumerate}
\item The discount rate is the rate of the window, typically 1\% higher than the federal fund rate to prevent it from being used to gain reserves
\begin{enumerate}
\item Reducing the rate difference 
\end{enumerate}
\item Open-market operations are
\begin{enumerate}
